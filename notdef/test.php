...
<div style=" padding: 0.6%; margin-left: 10%">
    ...
    <img src="a.png" width="40" height="50">
    &nbsp
    <a href="http://a0682981.xsph.ru/def/index.php" class="hover" style=" font-family: Roboto-Regular;">Switch</a>
    ...
    <a href="fileinj.php" class="underline-one" style="color: black; font-family: Roboto-Regular;  text-decoration: none;">File Injection</a>
